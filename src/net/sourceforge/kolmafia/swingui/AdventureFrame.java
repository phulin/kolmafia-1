...
public class AdventureFrame extends GenericFrame implements Listener {
  ...
  /**
   * Constructs a new <code>AdventureFrame</code>. All constructed panels are placed into their
   * corresponding tabs, with the content panel being defaulted to the adventure selection panel.
   */
  ...
  public JTabbedPane getSouthernTabs() {
    ...
    AdventureFrame.adventureSelector.addSelectedLocationListener(
        AdventureFrame.choiceOptionsPanel.getUpdateListener());
    return this.tabs;
  }
  ...
  public void dispose() {
    Preferences.setInteger(
        "defaultDropdownSplit", AdventureFrame.sessionGrid.getLastDividerLocation());
    super.dispose();
  }
